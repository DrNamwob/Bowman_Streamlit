...
if login():
    ...
    class CellCountsPage:
        def layout(self):
            ...
            selected_celltype = st.multiselect('Select cell type(s):', options=counts_data['celltype_broad'].unique(), default=counts_data['celltype_broad'].unique())
            selected_sex = st.multiselect('Select sex:', options=counts_data['sex'].unique(), default=counts_data['sex'].unique())
            selected_time = st.multiselect('Select time:', options=counts_data['time'].unique(), default=counts_data['time'].unique())
            selected_diet = st.multiselect('Select diet:', options=counts_data['diet'].unique(), default=counts_data['diet'].unique())

            filtered_data = counts_data[((counts_data['celltype_broad'].isin(selected_celltype)) & (counts_data['sex'].isin(selected_sex)) & (counts_data['time'].isin(selected_time)) & (counts_data['diet'].isin(selected_diet)))]
